...
const _10573d32 = () => interopDefault(import('../pages/particle.vue' /* webpackChunkName: "pages/particle" */))
const _543bfe5c = () => interopDefault(import('../pages/table.vue' /* webpackChunkName: "pages/table" */))
const _b1a3bee2 = () => interopDefault(import('../pages/accounts/bak.vue' /* webpackChunkName: "pages/accounts/bak" */))
const _5e526224 = () => interopDefault(import('../pages/accounts/lockscreen.vue' /* webpackChunkName: "pages/accounts/lockscreen" */))
...
export const routerOptions = {
  ...
  routes: [{
    ...
    path: "/accounts/lockscreen",
    component: _5e526224,
    name: "accounts-lockscreen"
  }, {
    path: "/accounts/login",
    component: _c4ad62a8,
    name: "accounts-login"
